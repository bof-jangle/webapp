...
public class ExecuteIntercept {
	// && 并 ! 非 。  即排除void返回值的方法。
	@Pointcut("execution (public * xyz.jangle.service.*.*(..)) && !execution (public void xyz.jangle.service.*.*(..))")
...
//			System.out.println(res);
			...
			e.printStackTrace();
			ResultModelMap<Object> resm = new ResultModelMap<Object>(CodeMessageEnum.error);
