	...
	<div style="margin-top: 20px;">
		<form id="jangleEditForm" name="jangleEditForm"	class="formJ">
			<div class="form-group" >
				...
				<input type="text" class="form-control" id="zdContent" name="zdContent" readonly />
			</div>
			<div class="form-group" >
				<label for="zdLyrUuid">zd_lyr_uuid：</label>
				<input type="text" class="form-control" id="zdLyrUuid" name="zdLyrUuid" readonly />
			</div>
			<div class="form-group" >
				<label for="zdLyr">zd_lyr：</label>
				<input type="text" class="form-control" id="zdLyr" name="zdLyr" readonly />
			</div>
			<div class="form-group" >
