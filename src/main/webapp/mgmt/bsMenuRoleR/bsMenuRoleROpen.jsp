...
<body>
	<div id="bodyTopDiv" class="jangle-openjsp-bodytopdiv" style="margin-top: 20px;">
		<span class="label label-info">基础框架的基础Demo详情查看</span>
	...
	<div style="margin-top: 20px;">
		<form id="jangleEditForm" name="jangleEditForm"	class="formJ">
			...
			<div class="form-group" >
				...
				<input type="text" class="form-control" id="menuId" name="menuId" readonly />
			</div>
			<div class="form-group" >
				<label for="roleId">角色ID：</label>
				<input type="text" class="form-control" id="roleId" name="roleId" readonly />
			</div>
			<div class="form-group">
