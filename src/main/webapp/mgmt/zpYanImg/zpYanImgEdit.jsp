...
<title>yan的作品_编辑页面_Jangle生成工具v1.1</title>
...
<body>
	...
	<div class="jangle-editjsp-formdiv" >
		<form id="jangleEditForm" name="jangleEditForm" class="formJ" >
			...
			<div class="form-group" >
				...
				<input type="text" class="form-control" id="imgPath" name="imgPath" placeholder="请输入图片路径" />
			</div>
	...
	<script type="text/javascript" src="js/zpYanImgEdit.js"></script>
	<script type="text/javascript">
		...
		function deleteForm() {
			if (confirm("确定删除此记录吗？")) {
				$.ajax({
					type:"POST",
					url : "/zpYanImgCtrl/deleteByPrimaryKey.ctrl",
					dataType : "json",
					cache : false,
					data : {
						"id" : $("#id").val()
