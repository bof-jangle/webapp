	    ...
	    <div>
	        <form class="navbar-form" role="search" id="searchForm">
	            <div class="form-group">
	            	<span class="jangle-listjsp-remarks-span label label-info" >简历访问记录 </span>
			...
			<table id="tablewrap" data-toggle="table" data-locale="zh-CN"
					...
					<thead style="text-align: center;">
						<tr>
							...
							<th data-field="resumeUri" >URI</th>
	...
	<script type="text/javascript">
		...
		function doCheckBoxes(){
			...
			if (confirm("确定删除勾选的"+rows.length+"条记录吗？")) {
				$.ajax({
					type:"POST",
					url : "/resumeAccessRecordCtrl/batchDeleteByPrimaryKey.ctrl",
					dataType : "json",
					cache : false,
					data : {
						"ids" : ids
