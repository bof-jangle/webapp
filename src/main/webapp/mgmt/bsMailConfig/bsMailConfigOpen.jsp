	...
	<div style="margin-top: 20px;">
		<form id="jangleEditForm" name="jangleEditForm"	class="formJ">
			<div class="form-group" >
				...
				<input type="text" class="form-control" id="mailProperty" name="mailProperty" readonly />
			</div>
			<div class="form-group" >
				<label for="mailValue">属性值：</label>
				<input type="text" class="form-control" id="mailValue" name="mailValue" readonly />
			</div>
			<div class="form-group" >
