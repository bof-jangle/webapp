...
<title>文件、资料_编辑页面_Jangle生成工具v1.1</title>
...
<body>
	<div id="bodyTopDiv" class="jangle-editjsp-bodytopdiv" >
		<span class="label label-info">文件、资料-内容编辑</span>
	...
	<script type="text/javascript" src="js/myFilesEdit.js"></script>
	<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data.code == "10001") {
						...
						fileInputParam["attSourceType"] = "my_files"; //填业务表名称
		...
		function deleteForm() {
			if (confirm("确定删除此记录吗？")) {
				$.ajax({
					type:"POST",
					url : "/myFilesCtrl/deleteByPrimaryKey.ctrl",
					dataType : "json",
					cache : false,
					data : {
						"id" : $("#id").val()
		...
		$(function() {
			...
			$.ajax({
				url : "/myFilesCtrl/selectByPrimaryKey.ctrl",
				dataType : "json",
				cache : false,
				data : {
					"id" : ps["id"]
			...
			// 加载附件
			loadAttachmentJ(ps["id"],"my_files",true);
		})
	</script>
</body>
</html>