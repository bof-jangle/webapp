...
<body>
	<div id="bodyTopDiv" class="jangle-openjsp-bodytopdiv" style="margin-top: 20px;">
		<span class="label label-info">字典表详情查看</span>
	...
	<div style="margin-top: 20px;">
		<form id="jangleEditForm" name="jangleEditForm"	class="formJ">
			...
			<div class="form-group" >
				...
				<input type="text" class="form-control" id="dkey" name="dkey" readonly />
			</div>
			<div class="form-group" >
				<label for="dvalue">dvalue：</label>
				<input type="text" class="form-control" id="dvalue" name="dvalue" readonly />
			</div>
			<div class="form-group">
