...
<!-- 	    </div> -->
	    <div>
	        <form class="navbar-form" role="search" id="searchForm">
	            <div class="form-group">
	            	<span class="jangle-listjsp-remarks-span label label-info" >测试表 </span>
			...
			<table id="tablewrap" data-toggle="table" data-locale="zh-CN"
					...
					<thead style="text-align: center;">
						<tr>
							...
							<th data-field="dmDesc" >remark</th>
	...
	<script type="text/javascript">
		...
		var url = "/bsTestCtrl/selectPage.ctrl";	//获取数据的url地址，需要实现分页功能。
		// 新增按钮 打开新增数据的页面
		function addFormInfo() {
			window.location.href = "bsTestEdit.jsp"
		}
		// 查看详情
		function openDetail(data) {
			window.location.href = "bsTestOpen.jsp?id=" + data.id + addressPostfix;
		}
		// 编辑详情
		...
		function doCheckBoxes(){
			...
			if (confirm("确定删除勾选的"+rows.length+"条记录吗？")) {
				$.ajax({
					type:"POST",
					url : "/bsTestCtrl/batchDeleteByPrimaryKey.ctrl",
					dataType : "json",
					cache : false,
					data : {
						"ids" : ids
